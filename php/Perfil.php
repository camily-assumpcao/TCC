  ...
  <div class="container">
    ...
    <div class="form">
        ...
        <div class="input-group">
          ...
          <div class="input-box">
            <lable for="usuario"><strong>Usuario:</strong></lable>
            <lable for="usuariobd"><?php echo $usuario ?></lable>
          </div>

          <div class="input-box">
            <lable for="usuario"><strong>Senha:</strong></lable>
            <lable for="usuariobd">********</lable>
            <a href="MudarSenha.php?id=<?php echo $id?>">
        ...
        <div class="altera-button">
          <a href="AlterarInfo_Usuario.php?id=<?php echo $id?>">
          ...
          function Delete() {
            swal
              ({
                ...
                if (value) {
                  window.location.assign("ExcluirContaUser.php?id=<?=$id ?>");
                }
              })
            return false;
          }
