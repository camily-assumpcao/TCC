...
<body>
  ...
  <div class="container">
    <form class="form">
      <center>
      <a href="EmprestimosPendentes.php" class="btnEmprestimos"> Emprestimos em Andamento</a>
    <br><br>
    <br><br>
    <a href="emprestimosConcluidos.php" class="btnEmprestimos"> Emprestimos Concluidos</a>
    </center>
