<?php 
    ...
    WHERE tblemprestimo.situacaoEmprestimo = 'Em andamento'";
...
<html lang="pt-br">
    <head>
        ...
        <title>Empréstimos em Andamento</title>
    </head>
    <body>
        <div class="container-principal">
            <div class="titulo">
                <h1>Empréstimos em andamento - SearchBook</h1>
                <br>
            </div>
            ...
            <div class="container-image" id="content">
                    ...
                    <div class="image">
                        ...
                        <br>
                        <?php echo "<strong>Código do empréstimo: </strong>" . $detalhesEmprestimo["idEmprestimo"] . "<p>"?>
                        <br>
                        ...
                        <a href="renovarEmprestimo.php?idEmprestimo=<?php echo $detalhesEmprestimo["idEmprestimo"];?>">
                            <button class="detalhes">Renovar Empréstimo</button>
                        </a>
                            <br><br>
                        <a href="concluirEmprestimo.php?idEmprestimo=<?php echo $detalhesEmprestimo["idEmprestimo"];?>">
                            <button class="detalhes">Concluir Empréstimo</button>
                        </a>
                    </div>
                    <?php 
                        } 
    ...
    <script>
        ...
        function searchData()
        {
            window.location='EmprestimosPendentes.php?search='+search.value;
        }
    </script>
</html>