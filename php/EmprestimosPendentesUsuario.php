<?php 
    ...
    WHERE tblusuario.CPF = $CPFUsuario AND tblemprestimo.situacaoEmprestimo = 'Em andamento'";
            ...
            <div class="container-principal">
                ...
                <div class="container-image">
                    ...
                    <div class="image">
                        ...
                        <br>
                        <a href="solicitarRenovacao.php?idEmprestimoSolicitacao=<?php echo $detalhesEmprestimo["idEmprestimo"];?>">
                            <button class="detalhes">Solicitar Renovação do Empréstimo</button>
                        </a>
                    </div>
                    <?php 
                        } 
