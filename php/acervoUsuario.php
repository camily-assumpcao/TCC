...
<html lang="pt-br">
    ...
    <body>
            <div class="container-principal">
                ...
                <form class="form">
                    ...
                    <input class="input" id="pesquisar" name="search" placeholder="Pesquisar Livro" required="" value="<?php if(isset($_GET['busca']))echo $_GET['busca'];?>" type="search">
                </form>
                </center>
                ...
                <div class="container-image">
                        ...
                        ?>
                        <div class="image">
                            <img height="200" src="<?php echo $livros['capaLivro']; ?>" alt="100">
                            <br>
                            <h3><?php echo $livros['titulo'];?></h3>
                            <br>
                            <br>
                            <a href="detalhesLivroUsuario.php?id=<?php echo $livros['codLivro'];?>">
    ...
    <script>
        ...
        function searchData()
        {
            window.location='acervoUsuario.php?search='+search.value;
        }
    </script>
</html>